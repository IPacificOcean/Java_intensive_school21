...
public class TransactionsService {
    ...
    public void transfer (int senderId, int recipientId, long transferAmount) {
        UUID tid = UUID.randomUUID();
        User sender = userList_.retrieveUserById(senderId);
        User recipient = userList_.retrieveUserById(recipientId);
